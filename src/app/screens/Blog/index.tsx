    ...
    const posts = [
        {
            ...
            resumo: "Reflexões sobre como codar também é poesia.",
            data: "Fev, 2026",
            categoria: "Artigo",
        ...
        },
        {
            ...
            resumo: "Prestação de serviços para o coletivo Enredo, colaboração com oficinar literárias para facilitar a construção de narrativas.",
            data: "fev, 2026",
            categoria: "Relato",
